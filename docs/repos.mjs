const repos = [
    ...
    "client-mq",
    "client-mturk",
    "client-mwaa-serverless",
    "client-mwaa",
    "client-neptune-graph",
    "client-neptune",
    "client-neptunedata",
    "client-network-firewall",
    "client-networkflowmonitor",
    "client-networkmanager",
    "client-networkmonitor",
    "client-notifications",
    "client-notificationscontacts",
    "client-nova-act",
    "client-oam",
    ...
    "client-outposts",
    "client-panorama",
    "client-partnercentral-account",
    "client-partnercentral-benefits",
    "client-partnercentral-channel",
    "client-partnercentral-selling",
    ...
    "client-sagemaker-runtime-http2",
    ...
    "client-snowball",
    "client-sns",
    "client-socialmessaging",
    "client-sqs",
    "client-ssm-contacts",
    "client-ssm-guiconnect",
